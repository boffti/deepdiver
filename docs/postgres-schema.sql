-- DeepDiver Local PostgreSQL Schema
-- Run this after starting postgres container:
--   docker-compose exec postgres psql -U deepdiver -d deepdiver -f /docker-entrypoint-initdb.d/schema.sql
